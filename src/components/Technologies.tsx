...
const categoryColors = {
  frontend: { bg: "from-cyan-500/20 to-cyan-500/5", text: "text-cyan-400", border: "border-cyan-500/30" },
  backend: { bg: "from-purple-500/20 to-purple-500/5", text: "text-purple-400", border: "border-purple-500/30" },
  tools: { bg: "from-pink-500/20 to-pink-500/5", text: "text-pink-400", border: "border-pink-500/30" },
  other: { bg: "from-gray-500/20 to-gray-500/5", text: "text-gray-400", border: "border-gray-500/30" },
};
    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="text-xs text-gray-500 mt-1">{tech.proficiency}%</span>
        </motion.div>
...
export function Technologies() {
  ...
  return (
    <section id="technologies" className="relative py-24 md:py-32 bg-[#0a0a0f]">
      ...
      />
      <motion.div
        className="absolute w-[250px] h-[250px] rounded-full bg-purple-500/10 blur-[60px]"
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {backend.map((tech, index) => (
              <TechCard key={tech.name} tech={tech} index={index + frontend.length} />
            ))}
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {tools.map((tech, index) => (
              <TechCard key={tech.name} tech={tech} index={index + frontend.length + backend.length} />
            ))}
          </div>
        </div>
      </div>
